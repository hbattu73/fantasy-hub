    ...
    <main class="flex flex-col flex-grow flex-shrink-0 items-center px-4 lg:px-16 pt-4">
        <div class="pb-3 pt-1 flex flex-col md:flex-row items-center md:items-start container">
            <div class="flex text-center md:text-start justify-center md:justify-start w-full">
                <div class="">
                    <h2 class="font-inter font-bold text-lg md:text-2xl text-light-text">Weekly Power Rankings</h2>
                    <h4 class="font-inter font-medium text-sm md:text-base text-slate-500">League and roster power rankings updated weekly.</h4>
                </div>
            </div>
        </div>
        <div class="flex flex-col items-center justify-center py-16 md:py-24">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-32 h-32 md:w-36 md:h-36 text-light-text">
            ...
            <span class="text-center py-6 font-inter text-slate-600 font-medium text-md md:text-lg">This feature is currently under construction. Check back before start of regular season.</span>
        </div>
    </main>
</template>